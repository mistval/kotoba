...
module.exports = [
  {
    ...
    [
      ...
      {
        userFacingName: 'Conquest Mode Enabled',
        description: 'This setting controls whether Conquest mode quizzes can be run. Say `k!quiz conquest` to find out more about what that is.',
        allowedValuesDescription: 'Either **enabled** or **disabled**',
      ...
      {
        userFacingName: 'Conquest Mode Percent Correct Threshold',
        description: 'In conquest mode, if you answer a question correctly more than this percent of the time, it will not be shown again.',
        allowedValuesDescription: 'A number between 1 and 100',
        uniqueId: 'quiz_conquest_mode_percent_correct_threshold',
        defaultUserFacingValue: '76',
        convertUserFacingValueToInternalValue: SettingsConverters.stringToInt,
        convertInternalValueToUserFacingValue: SettingsConverters.toString,
        validateInternalValue: SettingsValidators.createRangeValidator(1, 100),
      },
      {
        userFacingName: 'Conquest Mode Spacing Modifier',
        description: 'In conquest mode, reduce this to make missed questions appear again sooner. Increase it to make them appear again later. Setting this to 0.5 will make missed questions appear twice as often. Setting this to 2 will make them appear half as often.',
        allowedValuesDescription: 'A number between 0.1 and 10',
        uniqueId: 'quiz_conquest_mode_spacing_modifier',
