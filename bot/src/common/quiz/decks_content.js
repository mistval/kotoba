...
const categoryFields = [
  ...
  {name: 'Japanese Misc. Decks', value: 'hiragana katakana kanawords rtk_vocab rtk_all kotowaza common common_nojlpt k33 hard haard insane hentaigana kklc ranobe numbers yojijukugo kirakira dqn sao jsyn jsyn_full jptrivia kokuji onomato 擬音語 radicals jouyou images jpdefs myouji namae onago seiyuu cities prefectures countries emperors kunyomi pokemon'},
