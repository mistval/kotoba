...
const categoryFields = [
  ...
  {name: '用語 Decks', value: 'suugaku pasokon rikagaku igaku shinrigaku keizai houritsu kenchiku nature animals birds bugs fish plants vegetables'},
  ...
  {name: 'Japanese Misc. Decks', value: 'hiragana katakana kanawords rtk_vocab kotowaza common common_nojlpt k33 hard haard insane hentaigana kklc ranobe numbers yojijukugo kirakira dqn sao jsyn jsyn_full jptrivia kokuji onomato 擬音語 radicals jouyou images jpdefs myouji namae onago seiyuu cities prefectures countries emperors'},
  {name: 'English Decks', value: 'defs1 defs2 defs3 (up to defs17)\nanagrams4 anagrams5 anagrams6 (up to anagrams10)\nejtrans jeopardy esyn_easy esyn_med esyn_hard'},
...
module.exports.createContent = function(prefix) {
  return {
    embed: {
      title: 'Quiz',
      description: `Say **${prefix}quiz deckname** to start a quiz (Example: **${prefix}quiz N5**). Say **${prefix}quiz stop** to stop a quiz. Say **nodelay** after the deck name for a lightning fast quiz, for example: **k!quiz N1 nodelay**. [Visit me on the web](https://kotobaweb.com/bot/quiz) to see advanced options and settings that you can use.`,
