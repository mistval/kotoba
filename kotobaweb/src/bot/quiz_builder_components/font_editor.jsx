          ...
          <div className="card-body d-flex flex-row flex-wrap">
            ...
            <div className="mb-4 d-flex flex-column justify-content-between" style={{ flex: 1 }}>
              ...
              <div className="alert alert-info mb-0 mt-2" role="alert">
                The font family in the 本 example will only change if your computer has the font installed. Beware that Discord scales down <b>large</b> images, which can make text look blurry.
              </div>
            </div>
          </div>
        </div>
