...
export function Dashboard() {
  ...
  return (
    <>
      ...
      <Switch>
        { user && <Route path={`${match.path}/decks/:id`} component={CustomDeck} /> }
        <Route path={`${match.path}/game_reports/:id`} component={GameReport} />
        { user && <Route path={match.path} component={Main} /> }
      </Switch>
    </>
  );
}
