...
module.exports = {
  'embed': {
    ...
    'fields': [
      ...
      {'name': 'Japanese proper nouns', value: 'myouji namae onago places prefectures stations tokyo countries'},
      {'name': 'Mother Nature (not for the faint of heart)', value: 'animals birds bugs fish plants vegetables'},
      {'name': 'Kana', value: 'hiragana katakana'},
      {'name': 'Japanese Misc.', value: 'insane yojijukugo kokuji'},
