...
kotoba_directory=/home/ubuntu/kotoba
...
docker run -v $kotoba_directory/backup/gsutil_volume/:/var/backup gcr.io/google.com/cloudsdktool/google-cloud-cli:alpine /bin/bash -c "gcloud auth activate-service-account --key-file=/var/backup/gcloud_key.json && gsutil cp /var/backup/$file_name gs://$bucket_name"
